...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $slug_text = $request->slug_text ? $request->slug_text : $request->title;
        $slug = $this->createSlug($slug_text);
    ...
    public function update(Request $request, $id)
    {
        ...
        $article->update(array_merge($request->all(), ['header_img'=>$img_name, 'slug'=>$slug]));
